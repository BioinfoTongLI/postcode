...
def main(codebook_path, spot_profile_path, image_path, start_cycle = 2, channels_to_delete = ['DAPI']):
    ...
    channel_order_spot_profile = extract_channel_names(image_path)
    spot_profile_3d = prepare_spot_profile_ISS(spot_profile_path, Ncycles, Nchannels, channel_order_spot_profile, channel_order, start_cycle)
